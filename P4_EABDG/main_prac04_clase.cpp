...
letra W. Las letras pueden trasladarse, con la letra A se moverá hacia la izquierda, con la letra D 
se moverá hacia la derecha, con AvPag se moverá hacia arriba, con RePag se moverá hacia abajo, con W 
se alejará y con S se acercará.
...
void display(void)
{
	...
	glBindVertexArray(VAO);
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 0.0f, 1.0f));// Tronco
	model = glm::scale(model, glm::vec3(4, 5, 1));
	projectionShader.setMat4("model",model);
	glDrawArrays(GL_QUADS, 0, 24); //A lonely cube :(
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(0,-3.5, 0));//cinturon
	model = glm::scale(model, glm::vec3(4, 2, 1));
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 1.0f, 0.0f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(-1.5, -6.0, 0));//pierna izquierda
	model = glm::scale(model, glm::vec3(1, 3, 1));
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 1.0f, 1.0f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(-3.0, -8.0, 0));//pie izquierdo
	model = glm::scale(model, glm::vec3(4, 1, 1));
	projectionShader.setVec3("aColor", glm::vec3(0.6f, 0.3f, 0.0f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);
	
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(1.5, -6.0, 0));//pierna derecha
	model = glm::scale(model, glm::vec3(1, 3, 1));
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 1.0f, 1.0f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);
	
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(3.0, -8.0, 0));//pie derecho
	model = glm::scale(model, glm::vec3(4, 1, 1));
	projectionShader.setVec3("aColor", glm::vec3(0.6f, 0.3f, 0.0f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);
	
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(-3.0, 2.0, 0));//brazo izquierdo
	model = glm::scale(model, glm::vec3(2, 1, 1));
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 1.0f, 0.0f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(3.0, 2.0, 0));//brazo derecho
	model = glm::scale(model, glm::vec3(2, 1, 1));
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 1.0f, 0.0f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(-3.75, 0, 0));//antebrazo izquierdo
	model = glm::scale(model, glm::vec3(0.5, 3, 1));
	projectionShader.setVec3("aColor", glm::vec3(0.4f, 0.0f, 0.5f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(3.75, 0, 0));//antebrazo derecho
	model = glm::scale(model, glm::vec3(0.5, 3, 1));
	projectionShader.setVec3("aColor", glm::vec3(0.4f, 0.0f, 0.5f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);

	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(0, 2.75, 0));//cuello
	...
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 1.0f, 0.0f));//Aquí se cambia el color
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);
	model = glm::translate(model=glm::mat4(1.0f), glm::vec3(-6, 0, 0));
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 0.0f, 1.0f));//Aquí se cambia el color
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);
	*/
