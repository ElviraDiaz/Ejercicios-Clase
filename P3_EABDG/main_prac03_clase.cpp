...
/*--------------Elvira Angela Belem Díaz Gutiérrez-------------*/
/*------------Versión: Visual Studio 2017---------------*/
/*Instrucciones de uso:
Para poder observar las letras se deben desplazar en la coordenada de Z alejandose, esto de hace con la letra S.
Las letras pueden trasladarse, con la letra A se moverán hacia la izquierda, con la letra D se moverán hacia la
derecha, con la letra Q se moverán hacia arriba, con la letra E se moverán hacia abajo, con S se alejarán y con 
W se acercarán
*/
...
void display(void)
{
	...
	//inferior izq,inferior der,-y,y,-z,z
	
	//Use "view" in order to affect all models
	view = glm::translate(view, glm::vec3(movX, movY, movZ));
	//a que afecta, coordenadas     //Mueve el cuadrado de lugar
