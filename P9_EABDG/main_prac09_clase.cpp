...
Instrucciones de uso:
	Con las teclas del teclado se puede mover el conjunto de cajas
		D: Lo mueve a la izquierda
		A: Lo mueve a la derecha
		W: Lo acerca 
		S: Lo aleja
...
void LoadTextures()
{
	...
	t_bricks = generateTextures("Texturas/bricks.jpg", 0);
	t_Marmol = generateTextures("Texturas/Marmol.jpg", 0);
	t_Cielo = generateTextures("Texturas/Cielo.png", 1);
	t_zorro_rojo = generateTextures("Texturas/ZorroRojo.png", 1);
	t_zorro_rojo_Specular = generateTextures("Texturas/ZorroRojo_Specular.png", 1);
	t_naranja=generateTextures("Texturas/Naranja.png", 1);
	t_naranja_Specular= generateTextures("Texturas/naranja_Specular_2.png", 1);
	t_erizo=generateTextures("Texturas/Erizo.jpg", 0);
	t_erizo_cobijita= generateTextures("Texturas/Erizo_Cobijita.png", 1);
	...
	glBindTexture(GL_TEXTURE_2D, t_zorro_rojo);
	glActiveTexture(GL_TEXTURE13);
	glBindTexture(GL_TEXTURE_2D, t_zorro_rojo_Specular);
	glActiveTexture(GL_TEXTURE14);
	glBindTexture(GL_TEXTURE_2D, t_naranja);
	glActiveTexture(GL_TEXTURE15);
	glBindTexture(GL_TEXTURE_2D, t_naranja_Specular);
	glActiveTexture(GL_TEXTURE16);
	glBindTexture(GL_TEXTURE_2D, t_erizo);
	glActiveTexture(GL_TEXTURE17);
	glBindTexture(GL_TEXTURE_2D, t_erizo_cobijita);
...
//Caja Ejercicio
	//Atrás
	model = glm::translate(glm::mat4(1.0f), glm::vec3(2.5f, 2.5f,-3.0f)); 
	model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
	lightingShader.setMat4("model", model);
	...
	//Izquierda
	lightingShader.setMat4("model", model);
	lightingShader.setInt("material_specular", t_zorro_rojo_Specular);
	lightingShader.setInt("material_diffuse", t_zorro_rojo);
	glDrawArrays(GL_QUADS, 32, 4);
	//Derecha
	lightingShader.setMat4("model", model);
	lightingShader.setInt("material_specular", t_naranja_Specular);
	lightingShader.setInt("material_diffuse", t_naranja);
